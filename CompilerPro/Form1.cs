                                    ...
                                    if (Lines[i].ToCharArray()[y + 7] == '<')
                                    {
                                        for (int x1 = 0; x1 < L1.Count; x1++)
                                        {
                                            if (Lines[i].ToCharArray()[y + 11] == L1[x1].name && Lines[i].ToCharArray()[y + 12] == '=' && Lines[i].ToCharArray()[y + 13] == L1[x1].name && Lines[i].ToCharArray()[y + 14] == '+')
                                            {
                                                ...
                                                {
                                                    if (Lines[i].ToCharArray()[y + 25] == 'b' && Lines[i].ToCharArray()[y + 26] == 'r' && Lines[i].ToCharArray()[y + 27] == 'e' && Lines[i].ToCharArray()[y + 28] == 'a' && Lines[i].ToCharArray()[y + 29] == 'k' && Lines[i].ToCharArray()[y + 30] == ';' && flag5 == 0)
                                                    {
                                                        MessageBox.Show("break");
                                                        flag5 = 1;
                                                    }
                                                    if (Lines[i].ToCharArray()[y + 25] == 'c' && Lines[i].ToCharArray()[y + 26] == 'o' && Lines[i].ToCharArray()[y + 27] == 'n' && Lines[i].ToCharArray()[y + 28] == 't' && Lines[i].ToCharArray()[y + 29] == 'i' && Lines[i].ToCharArray()[y + 30] == 'n' && Lines[i].ToCharArray()[y + 31] == 'u' &&Lines[i].ToCharArray()[y + 32] == 'e'&& flag5 == 0)
                                                    {
